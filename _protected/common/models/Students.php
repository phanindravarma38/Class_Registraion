...
/**
 * This is the Students model class extending StudentIdentity.
 * Here you can implement your custom user solutions.
 *
 * @property $role Role
 */
class Students extends StudentIdentity
{
    ...
    {
        return [
            [['username', 'email','name'], 'filter', 'filter' => 'trim'],
    ...
    {
        return $this->hasMany(Article::className(), ['student_id' => 'id']);
    }    
...
//------------------------------------------------------------------------------------------------//
    ...
    {
        return static::findOne(['username' => $username, 'status' => Students::STATUS_ACTIVE]);
    }  
    ...
    {
        return static::findOne(['email' => $email, 'status' => Students::STATUS_ACTIVE]);
    } 
    ...
    public static function findByAccountActivationToken($token)
    {
        return static::findOne([
            ...
            'status' => Students::STATUS_NOT_ACTIVE,
        ]);
    }
